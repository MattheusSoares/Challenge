(function () {
  ...
  (self["webpackChunklorax"] = self["webpackChunklorax"] || []).push([["default-node_modules_angular_material___ivy_ngcc___fesm2015_sort_js-node_modules_angular_mate-d6196c"], {
    /***/
    11494:
    /*!**********************************************************************!*\
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _MatToolbar = /*#__PURE__*/function (_MatToolbarBase2) {
        ...
        var _super3 = _createSuper(_MatToolbar);
        ...
        function _MatToolbar(elementRef, _platform, document) {
          ...
          _this5 = _super3.call(this, elementRef);
          _this5._platform = _platform; // TODO: make the document a required param when doing breaking changes.

          _this5._document = document;
          return _this5;
        }
          ...
          value: function ngAfterViewInit() {
            ...
            if (this._platform.isBrowser) {
              ...
              this._toolbarRows.changes.subscribe(function () {
                return _this6._checkToolbarMixedModes();
              });
            }
          }
          /**
          ...
          value: function _checkToolbarMixedModes() {
            ...
            if (this._toolbarRows.length && (typeof ngDevMode === 'undefined' || ngDevMode)) {
              ...
              var isCombinedUsage = Array.from(this._elementRef.nativeElement.childNodes).filter(function (node) {
                ...
                return node.nodeType !== (_this7._document ? _this7._document.COMMENT_NODE : 8);
              }).some(function (node) {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _FileInputComponent = FileInputComponent_1 = /*#__PURE__*/function (_FileInputMixinBase) {
        ...
        function FileInputComponent(fm, _elementRef, _renderer, _defaultErrorStateMatcher, ngControl, _parentForm, _parentFormGroup) {
          ...
          _this8 = _super4.call(this, _defaultErrorStateMatcher, _parentForm, _parentFormGroup, ngControl);
          _this8.fm = fm;
          _this8._elementRef = _elementRef;
          _this8._renderer = _renderer;
          _this8._defaultErrorStateMatcher = _defaultErrorStateMatcher;
          _this8.ngControl = ngControl;
          _this8._parentForm = _parentForm;
          _this8._parentFormGroup = _parentFormGroup;
          _this8.focused = false;
          _this8.controlType = 'file-input';
          _this8.autofilled = false;
          _this8._required = false;
          _this8.accept = null;
          _this8.id = "ngx-mat-file-input-".concat(FileInputComponent_1.nextId++);
          _this8.describedBy = '';
...
//# sourceMappingURL=default-node_modules_angular_material___ivy_ngcc___fesm2015_sort_js-node_modules_angular_mate-d6196c-es5.js.map