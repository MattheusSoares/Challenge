(function () {
  ...
  (self["webpackChunklorax"] = self["webpackChunklorax"] || []).push([["default-node_modules_angular_material___ivy_ngcc___fesm2015_tabs_js"], {
    /***/
    65939:
    /*!**********************************************************************!*\
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _MatTabLabel = /*#__PURE__*/function (_angular_cdk_portal__) {
        ...
        var _super = _createSuper(_MatTabLabel);
        ...
        function _MatTabLabel(templateRef, viewContainerRef, _closestTab) {
          ...
          _this2 = _super.call(this, templateRef, viewContainerRef);
          _this2._closestTab = _closestTab;
          return _this2;
        }
      ...
      var _MatTab = /*#__PURE__*/function (_MatTabBase2) {
        ...
        var _super2 = _createSuper(_MatTab);
        ...
        function _MatTab(_viewContainerRef, _closestTabGroup) {
          ...
          _this3._closestTabGroup = _closestTabGroup;
          /** Plain text label for the tab, used when there is no template label. */

          _this3.textLabel = '';
          /** Portal that will be the hosted content of the tab */

          _this3._contentPortal = null;
      ...
      var _MatTabBodyPortal = /*#__PURE__*/function (_angular_cdk_portal__2) {
        ...
        var _super3 = _createSuper(_MatTabBodyPortal);
        ...
        function _MatTabBodyPortal(componentFactoryResolver, viewContainerRef, _host, _document) {
          ...
          _this4 = _super3.call(this, componentFactoryResolver, viewContainerRef, _document);
          _this4._host = _host;
          /** Subscription to events for when the tab body begins centering. */

          _this4._centeringSub = rxjs__WEBPACK_IMPORTED_MODULE_6__.Subscription.EMPTY;
          /** Subscription to events for when the tab body finishes leaving from center position. */

          _this4._leavingSub = rxjs__WEBPACK_IMPORTED_MODULE_6__.Subscription.EMPTY;
          return _this4;
        }
        ...
        _createClass(_MatTabBodyPortal, [{
          ...
          value: function ngOnInit() {
            ...
            this._centeringSub = this._host._beforeCentering.pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.startWith)(this._host._isCenterPosition(this._host._position))).subscribe(function (isCentering) {
              if (isCentering && !_this5.hasAttached()) {
                _this5.attach(_this5._host._content);
              }
            });
        ...
        function _MatTabBodyBase2(_elementRef, _dir, changeDetectorRef) {
          ...
          if (_dir) {
            this._dirChangeSubscription = _dir.change.subscribe(function (dir) {
              _this6._computePositionAnimationState(dir);
          ...
          this._translateTabComplete.pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_9__.distinctUntilChanged)(function (x, y) {
            ...
            if (_this6._isCenterPosition(event.toState) && _this6._isCenterPosition(_this6._position)) {
              _this6._onCentered.emit();
            }

            if (_this6._isCenterPosition(event.fromState) && !_this6._isCenterPosition(_this6._position)) {
              _this6._afterLeavingCenter.emit();
            }
          });
        }
      ...
      var _MatTabBody = /*#__PURE__*/function (_MatTabBodyBase3) {
        ...
        var _super4 = _createSuper(_MatTabBody);
      ...
      var _MatTabGroupBase2 = /*#__PURE__*/function (_MatTabGroupMixinBase2) {
        ...
        var _super5 = _createSuper(_MatTabGroupBase2);
        ...
        function _MatTabGroupBase2(elementRef, _changeDetectorRef, defaultConfig, _animationMode) {
          ...
          _this7 = _super5.call(this, elementRef);
          _this7._changeDetectorRef = _changeDetectorRef;
          _this7._animationMode = _animationMode;
          /** All of the tabs that belong to the group. */

          _this7._tabs = new _angular_core__WEBPACK_IMPORTED_MODULE_0__.QueryList();
          /** The tab index that should be selected after the content has been checked. */

          _this7._indexToSelect = 0;
          /** Snapshot of the height of the tab body wrapper before another tab is activated. */

          _this7._tabBodyWrapperHeight = 0;
          /** Subscription to tabs being added/removed. */

          _this7._tabsSubscription = rxjs__WEBPACK_IMPORTED_MODULE_6__.Subscription.EMPTY;
          /** Subscription to changes in the tab labels. */

          _this7._tabLabelSubscription = rxjs__WEBPACK_IMPORTED_MODULE_6__.Subscription.EMPTY;
          _this7._selectedIndex = null;
          /** Position of the tab header. */

          _this7.headerPosition = 'above';
          /** Output to enable support for two-way binding on `[(selectedIndex)]` */

          _this7.selectedIndexChange = new _angular_core__WEBPACK_IMPORTED_MODULE_0__.EventEmitter();
          /** Event emitted when focus has changed within a tab group. */

          _this7.focusChange = new _angular_core__WEBPACK_IMPORTED_MODULE_0__.EventEmitter();
          /** Event emitted when the body animation has completed */

          _this7.animationDone = new _angular_core__WEBPACK_IMPORTED_MODULE_0__.EventEmitter();
          /** Event emitted when the tab selection has changed. */

          _this7.selectedTabChange = new _angular_core__WEBPACK_IMPORTED_MODULE_0__.EventEmitter(true);
          _this7._groupId = nextId++;
          _this7.animationDuration = defaultConfig && defaultConfig.animationDuration ? defaultConfig.animationDuration : '500ms';
          _this7.disablePagination = defaultConfig && defaultConfig.disablePagination != null ? defaultConfig.disablePagination : false;
          _this7.dynamicHeight = defaultConfig && defaultConfig.dynamicHeight != null ? defaultConfig.dynamicHeight : false;
          _this7.contentTabIndex = (_a = defaultConfig === null || defaultConfig === void 0 ? void 0 : defaultConfig.contentTabIndex) !== null && _a !== void 0 ? _a : null;
          return _this7;
        }
        ...
        _createClass(_MatTabGroupBase2, [{
          ...
          value: function ngAfterContentChecked() {
            ...
            if (this._selectedIndex != indexToSelect) {
              ...
              Promise.resolve().then(function () {
                _this8._tabs.forEach(function (tab, index) {
                  return tab.isActive = index === indexToSelect;
                });

                if (!isFirstRun) {
                  _this8.selectedIndexChange.emit(indexToSelect); // Clear the min-height, this was needed during tab change to avoid
                  // unnecessary scrolling.


                  _this8._tabBodyWrapper.nativeElement.style.minHeight = '';
                }
              });
            ...
            this._tabs.forEach(function (tab, index) {
              ...
              if (_this8._selectedIndex != null && tab.position == 0 && !tab.origin) {
                tab.origin = indexToSelect - _this8._selectedIndex;
              }
            });
          ...
          value: function ngAfterContentInit() {
            ...
            this._tabsSubscription = this._tabs.changes.subscribe(function () {
              var indexToSelect = _this9._clampTabIndex(_this9._indexToSelect); // Maintain the previously-selected tab if a new tab is added or removed and there is no
              // explicit change that selects a different tab.


              if (indexToSelect === _this9._selectedIndex) {
                var tabs = _this9._tabs.toArray();
                ...
                for (var i = 0; i < tabs.length; i++) {
                  if (tabs[i].isActive) {
                    ...
                    _this9._indexToSelect = _this9._selectedIndex = i;
                    break;
                  }
                }
              }
          ...
          value: function _subscribeToAllTabChanges() {
            ...
            this._allTabs.changes.pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.startWith)(this._allTabs)).subscribe(function (tabs) {
              _this10._tabs.reset(tabs.filter(function (tab) {
                return tab._closestTabGroup === _this10 || !tab._closestTabGroup;
              }));

              _this10._tabs.notifyOnChanges();
            });
          }
        }, {
          key: "ngOnDestroy",
      ...
      var _MatTabGroup = /*#__PURE__*/function (_MatTabGroupBase3) {
        ...
        var _super6 = _createSuper(_MatTabGroup);
      ...
      var _MatTabLabelWrapper = /*#__PURE__*/function (_MatTabLabelWrapperBa) {
        ...
        var _super7 = _createSuper(_MatTabLabelWrapper);
      ...
      var MatPaginatedTabHeader = /*#__PURE__*/function () {
        function MatPaginatedTabHeader(_elementRef, _changeDetectorRef, _viewportRuler, _dir, _ngZone, _platform, _animationMode) {
          ...
          _ngZone.runOutsideAngular(function () {
            (0, rxjs__WEBPACK_IMPORTED_MODULE_15__.fromEvent)(_elementRef.nativeElement, 'mouseleave').pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_16__.takeUntil)(_this13._destroyed)).subscribe(function () {
              _this13._stopInterval();
            });
          });
        }
        /** The index of the active tab. */
        ...
        _createClass(MatPaginatedTabHeader, [{
          ...
          value: function ngAfterViewInit() {
            ...
            (0, rxjs__WEBPACK_IMPORTED_MODULE_15__.fromEvent)(this._previousPaginator.nativeElement, 'touchstart', passiveEventListenerOptions).pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_16__.takeUntil)(this._destroyed)).subscribe(function () {
              _this14._handlePaginatorPress('before');
            });
            (0, rxjs__WEBPACK_IMPORTED_MODULE_15__.fromEvent)(this._nextPaginator.nativeElement, 'touchstart', passiveEventListenerOptions).pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_16__.takeUntil)(this._destroyed)).subscribe(function () {
              _this14._handlePaginatorPress('after');
            });
          }
        }, {
          key: "ngAfterContentInit",
          value: function ngAfterContentInit() {
            ...
            (0, rxjs__WEBPACK_IMPORTED_MODULE_12__.merge)(dirChange, resize, this._items.changes).pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_16__.takeUntil)(this._destroyed)).subscribe(function () {
              ...
              _this15._keyManager.withHorizontalOrientation(_this15._getLayoutDirection());
            ...
            this._keyManager.change.pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_16__.takeUntil)(this._destroyed)).subscribe(function (newFocusIndex) {
              _this15.indexFocused.emit(newFocusIndex);

              _this15._setTabFocus(newFocusIndex);
            });
          }
        }, {
          key: "ngAfterContentChecked",
          ...
          value: function _onContentChanges() {
            ...
            if (textContent !== this._currentTextContent) {
              ...
              this._ngZone.run(function () {
                ...
                _this16._alignInkBarToSelectedTab();
          ...
          value: function _handlePaginatorPress(direction, mouseEvent) {
            ...
            .pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_16__.takeUntil)((0, rxjs__WEBPACK_IMPORTED_MODULE_12__.merge)(this._stopScrolling, this._destroyed))).subscribe(function () {
              var _this17$_scrollHeader = _this17._scrollHeader(direction),
                  maxScrollDistance = _this17$_scrollHeader.maxScrollDistance,
                  distance = _this17$_scrollHeader.distance; // Stop the timer if we've reached the start or the end.


              if (distance === 0 || distance >= maxScrollDistance) {
                _this17._stopInterval();
              }
            });
          }
          /**
      ...
      var _MatTabHeaderBase2 = /*#__PURE__*/function (_MatPaginatedTabHeade) {
        ...
        var _super8 = _createSuper(_MatTabHeaderBase2);
        ...
        function _MatTabHeaderBase2(elementRef, changeDetectorRef, viewportRuler, dir, ngZone, platform, animationMode) {
          ...
          _this18 = _super8.call(this, elementRef, changeDetectorRef, viewportRuler, dir, ngZone, platform, animationMode);
      ...
      var _MatTabHeader = /*#__PURE__*/function (_MatTabHeaderBase3) {
        ...
        var _super9 = _createSuper(_MatTabHeader);
      ...
      var _MatTabNavBase2 = /*#__PURE__*/function (_MatPaginatedTabHeade2) {
        ...
        var _super10 = _createSuper(_MatTabNavBase2);
        ...
        function _MatTabNavBase2(elementRef, dir, ngZone, changeDetectorRef, viewportRuler, platform, animationMode) {
          ...
          _this19 = _super10.call(this, elementRef, changeDetectorRef, viewportRuler, dir, ngZone, platform, animationMode);
          _this19._disableRipple = false;
          /** Theme color of the nav bar. */

          _this19.color = 'primary';
          return _this19;
        }
      ...
      var _MatTabNav = /*#__PURE__*/function (_MatTabNavBase3) {
        ...
        var _super11 = _createSuper(_MatTabNav);
      ...
      var _MatTabLinkBase2 = /*#__PURE__*/function (_MatTabLinkMixinBase2) {
        ...
        var _super12 = _createSuper(_MatTabLinkBase2);
      ...
      var _MatTabLink = /*#__PURE__*/function (_MatTabLinkBase3) {
        ...
        var _super13 = _createSuper(_MatTabLink);
        ...
        function _MatTabLink(tabNavBar, elementRef, ngZone, platform, globalRippleOptions, tabIndex, focusMonitor, animationMode) {
          ...
          _this22 = _super13.call(this, tabNavBar, elementRef, globalRippleOptions, tabIndex, focusMonitor, animationMode);
          _this22._tabLinkRipple = new _angular_material_core__WEBPACK_IMPORTED_MODULE_3__.RippleRenderer(_assertThisInitialized(_this22), ngZone, elementRef, platform);

          _this22._tabLinkRipple.setupTriggerEvents(elementRef.nativeElement);
...
//# sourceMappingURL=default-node_modules_angular_material___ivy_ngcc___fesm2015_tabs_js-es5.js.map