  ...
  (self["webpackChunklorax"] = self["webpackChunklorax"] || []).push([["src_app_views_calendar_calendar_module_ts"], {
    ...
    function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _CalendarComponent = /*#__PURE__*/function (_shared_UnsubscribeOn) {
        ...
        var _super2 = _createSuper(_CalendarComponent);
        ...
        function _CalendarComponent(fb, dialog, calendarService, snackBar) {
          ...
          _this2.calendarService = calendarService;
          _this2.snackBar = snackBar;
          _this2.filterOptions = 'All';
          _this2.filterItems = ['work', 'personal', 'important', 'travel', 'friends'];
          _this2.filters = [{
            name: 'work',
            value: 'Work',
            checked: true
          ...
          _this2.calendarOptions = {
            ...
            selectMirror: true,
            dayMaxEvents: true,
            select: _this2.handleDateSelect.bind(_assertThisInitialized(_this2)),
            eventClick: _this2.handleEventClick.bind(_assertThisInitialized(_this2)),
            eventsSet: _this2.handleEvents.bind(_assertThisInitialized(_this2))
          };
          _this2.dialogTitle = 'Add New Event';
          _this2.calendar = new _calendar_model__WEBPACK_IMPORTED_MODULE_0__.Calendar({});
          _this2.addCusForm = _this2.createCalendarForm(_this2.calendar);
          return _this2;
        }
          ...
          value: function addNewEvent() {
            ...
            this.subs.sink = dialogRef.afterClosed().subscribe(function (result) {
              if (result === 'submit') {
                ...
                _this3.calendarEvents = _this3.calendarEvents.concat({
                  // add new event data. must create new array
                  id: _this3.calendarData.id,
                  title: _this3.calendarData.title,
                  start: _this3.calendarData.startDate,
                  end: _this3.calendarData.endDate,
                  className: _this3.getClassNameValue(_this3.calendarData.category),
                  groupId: _this3.calendarData.category,
                  details: _this3.calendarData.details
                });
          ...
          value: function eventClick(row) {
            ...
            this.subs.sink = dialogRef.afterClosed().subscribe(function (result) {
              if (result === 'submit') {
                ...
                _this4.calendarEvents.forEach(function (element, index) {
...
//# sourceMappingURL=src_app_views_calendar_calendar_module_ts-es5.js.map